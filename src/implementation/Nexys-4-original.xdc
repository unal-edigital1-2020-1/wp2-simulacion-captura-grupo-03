...
set_property PACKAGE_PIN M2 [get_ports { VGA_B[2] }]				
...
set_property PACKAGE_PIN M3 [get_ports { VGA_G[0] }]				
...
set_property PACKAGE_PIN N2 [get_ports { VGA_G[2] }]				
...
set_property PACKAGE_PIN L14 [get_ports VGA_Hsync_n]						
	#set_property IOSTANDARD LVCMOS33 [get_ports Hsync]
##Bank = 15, Pin name = IO_L3N_T0_DQS_AD1N_15,				Sch name = VGA_VS
set_property PACKAGE_PIN K3 [get_ports VGA_Vsync_n]						
